...
/***/ function(module, exports, __webpack_require__) {
	...
	var _map_generator = __webpack_require__(166);

	var _map_generator2 = _interopRequireDefault(_map_generator);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_map_generator2.default, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _map_content = __webpack_require__(167);
	...
	var MapGenerator = (function (_Component) {
	    _inherits(MapGenerator, _Component);

	    function MapGenerator() {
	        _classCallCheck(this, MapGenerator);

	        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(MapGenerator).call(this));
	    ...
	    _createClass(MapGenerator, [{
	        ...
	        value: function componentDidMount() {
	            var data = localStorage.getItem('map_generator_data');
	        ...
	        value: function render() {
	            var result = this.transToExportData();
	            return _react2.default.createElement(
	                'div',
	                { style: styles.generatorWrap },
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        null,
	                        'columns: ',
	                        _react2.default.createElement('input', { type: 'text', onChange: this.changeSize.bind(this), 'data-type': 'columns', value: this.state.columns })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        null,
	        ...
	        key: 'transToExportData',
	        value: function transToExportData() {
	            var list = Array.from(this.state.checkList).sort(function (a, b) {
	                return a - b;
	            });
	            var data = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapContent = (function (_Component2) {
	    _inherits(MapContent, _Component2);

	    function MapContent() {
	        _classCallCheck(this, MapContent);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(MapContent).apply(this, arguments));
	    }
	        ...
	        value: function render() {
	            ...
	            var _loop = function _loop(i) {
	                ...
	                var _loop2 = function _loop2(j) {
	                    var index = i * _this2.props.columns + j;
	                    row.push(_react2.default.createElement(Block, { key: index, onSelectItem: function onSelectItem() {
	                            return _this2.props.onSelectItem(index, j, i);
	                        },
	                        isChecked: _this2.props.checkList.has(index) }));
	                };

	                for (var j = 0; j < _this2.props.columns; j++) {
	                    _loop2(j);
	                }
